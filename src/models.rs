...
pub struct PortalRequest {
    ...
    pub leave_vacation_location: Option<String>,
    pub leave_vacation_specify: Option<String>,
    pub leave_sick_location: Option<String>,
    pub leave_sick_illness: Option<String>,
    pub leave_women_illness: Option<String>,
    pub leave_study_purpose: Option<String>,
    pub leave_other_purpose: Option<String>,
    ...
    pub approved_days_with_pay: Option<String>,
    pub approved_days_without_pay: Option<String>,
    pub approved_other: Option<String>,
