...
<body>
  <main class="sheet">
    ...
    ${printRow('3. Date of Filing', formatDate(request.date))}
    ...
    <section class="section">
      ...
      <table>
        ...
        <tbody><tr><td><strong>Total Earned</strong></td><td></td><td></td></tr><tr><td><strong>Less this application</strong></td><td></td><td></td></tr><tr><td><strong>Balance</strong></td><td></td><td></td></tr></tbody>
      </table>
